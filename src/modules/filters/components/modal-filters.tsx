...
const ModalFilters = () => {
  ...
  return (
    ...
    >
      <div className="absolute animate-modal p-4 w-modal min-h-modal shadow-md border border-zinc-300 top-1/2 -translate-y-1/2 right-1/2 translate-x-1/2 bg-white rounded-lg">
        Filtros
      </div>
    </Modal>
  )
