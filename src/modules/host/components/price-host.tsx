...
export const PriceHost = () => {
  return (
    <>
      <Heading title="Agora, defina o preço" subtitle="Quanto será o valor por noite?" />
      ...
      <p className="w-full animate-slide-up text-sm text-zinc-300">
        *Adicione o preço considerando todos os impostos incluídos de acordo com as diretrízes
        do site.*
      </p>
    </>
  )
